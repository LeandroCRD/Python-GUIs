...
def click():
    ...
    label1.grid(row=2,column=1, columnspan=2, ipadx=20, ipady=4)
...
button1=Button(root,text="Click",command=click, width=6,borderwidth=2)
button1.grid(row=1,column=1,sticky='W',pady=5, padx=8)
button2=Button(root,text="Reset",command=rs, width=6,borderwidth=2)
